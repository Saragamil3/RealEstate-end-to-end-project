...
constraint Lead_property_fk foreign key(Property_sk)  references Dim_Property(Property_sk),
constraint Lead_Lead_ID_fk foreign key(Customer_sk)  references Dim_Lead(Lead_sk),
constraint Lead_agent_fk foreign key(Agent_sk)  references Dim_Agents(Agent_sk),
constraint Lead_campaign_fk foreign key(Campaign_sk)  references Dim_Campaigns(Campaign_sk),
constraint Lead_date_fk foreign key(Created_Date_sk)  references DimDate(DateSK) 
);
...
constraint sales_customer_fk foreign key(customer_sk)  references Dim_Lead(Lead_sk),
